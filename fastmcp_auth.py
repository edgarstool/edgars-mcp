...
try:
    ...
    create_protected_resource_routes = None  # type: ignore
...
def get_prm_routes_from_mcp_sdk(
    ...
    """
    if not FASTMCP_AUTH_AVAILABLE or create_protected_resource_routes is None:
        return []
    base_url = base_url.rstrip("/")
    resource_url = f"{base_url}{mcp_path}"
