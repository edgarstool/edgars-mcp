import { n as notImplemented } from "./utils-8DtQj6pW.js";
...
var getEnvironmentData = function getEnvironmentData(key) {
	return _environmentData.get(key);
};
var setEnvironmentData = function setEnvironmentData(key, value) {
	_environmentData.set(key, value);
};
var isMainThread = true;
var isMarkedAsUntransferable = () => false;
var markAsUntransferable = function markAsUntransferable(value) {};
...
var threadId = 0;
var workerData = null;
var postMessageToThread = /* @__PURE__ */ notImplemented("worker_threads.postMessageToThread");
...
//#endregion
export { BroadcastChannel, MessageChannel, MessagePort, SHARE_ENV, Worker, worker_threads_default as default, getEnvironmentData, isInternalThread, isMainThread, isMarkedAsUntransferable, markAsUncloneable, markAsUntransferable, moveMessagePortToContext, parentPort, postMessageToThread, receiveMessageOnPort, resourceLimits, setEnvironmentData, threadId, workerData };

//# sourceMappingURL=unenv_node_worker___threads.js.map