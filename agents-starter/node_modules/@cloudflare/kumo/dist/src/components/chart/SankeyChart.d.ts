...
export declare function SankeyChart({ echarts, nodes, links, height, nodeWidth, nodePadding, showTooltip: enableTooltip, showNodeValues, formatValue, tooltipFormatter, defaultNodeColor, linkColor, linkOpacity, className, isDarkMode, onNodeClick, onLinkClick, }: SankeyChartProps): import("react/jsx-runtime").JSX.Element;
